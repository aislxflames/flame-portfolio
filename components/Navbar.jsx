...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-[100vw] top-0 bg-black/20 backdrop-blur-2xl flex justify-around items-center h-16 z-50">
      ...
      <ul className="md:flex sm:flex hidden gap-5 text-sm [&>li]:font-[500] [&>li]:hover:scale-105 [&>li]:cursor-pointer [&>li]:hover:font-bold [&>li]:transition-[color,scale] [&>li]:duration-300 [&>li]:ease-in-out [&>li]:hover:border-b-2 [&>li]:hover:border-b-appricon-500 [&>li]:hover:text-cherry-500">
